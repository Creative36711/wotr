...
0.45.3 restores region overlay labels above all map markers, aligns the add-domain/add-stronghold controls with the counters, and improves English fallback text in the editor.
