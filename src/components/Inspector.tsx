    ...
    <aside className="side-panel right-panel">
      ...
      <div className="inspector-body">
        ...
        {!readonly ? <section className="inspector-section">
          ...
          <header><div><small>{SETTLEMENT_LABELS[location.economicType]}</small><b>Экономика объекта</b></div><span>+{location.income.gold} зол. · +{location.income.materials} мат.</span></header>
