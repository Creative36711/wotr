...
const OWNER_BONUSES: Partial<Record<SettlementType, BattleModifierSet>> = {
  ...
  ford: { owner: { ambushBonus: 0.1 } },
  pass: { owner: { ambushBonus: 0.15, defenseBonus: 0.05 } },
  ruins: { owner: { ambushBonus: 0.05 } },
  forest: { owner: { ambushBonus: 0.15, spawnBonus: 'ents' } },
  mountains: { owner: { defenseBonus: 0.05, spawnBonus: 'trolls' } },
