...
export const ALL_SETTLEMENT_TYPES: SettlementType[] = [
  ...
  'wilderness', 'swamp', 'forest', 'mountains', 'ruins', 'crossroads',
...
export const DEFAULT_ECONOMIC_TYPES: EconomicTypeDefinition[] = [
  { id: 'village', name: 'Village', nameTranslations: ru('Деревня'), gold: 30, materials: 0, recruitmentSlots: 1, reserveLimit: 5, visionRadius: 2, defenseBonus: 0.1, battleType: 'settlement', allowsCaptainHire: false, isCapital: false, allowedForDomain: true, allowedForStronghold: false },
  { id: 'city', name: 'City', nameTranslations: ru('Город'), gold: 80, materials: 10, recruitmentSlots: 2, reserveLimit: 10, visionRadius: 3, defenseBonus: 0.2, battleType: 'settlement', allowsCaptainHire: true, isCapital: false, allowedForDomain: true, allowedForStronghold: false },
  ...
  { id: 'mine', name: 'Mine / Forge', nameTranslations: ru('Шахта / кузница'), gold: 20, materials: 40, recruitmentSlots: 2, reserveLimit: 10, visionRadius: 2, defenseBonus: 0.1, battleType: 'settlement', allowsCaptainHire: false, isCapital: false, allowedForDomain: true, allowedForStronghold: false },
  { id: 'farm', name: 'Farm / Pasture', nameTranslations: ru('Ферма / пастбище'), gold: 50, materials: 0, recruitmentSlots: 1, reserveLimit: 8, visionRadius: 2, defenseBonus: 0.1, battleType: 'settlement', allowsCaptainHire: false, isCapital: false, allowedForDomain: true, allowedForStronghold: false },
  { id: 'wilderness', name: 'Wilderness', nameTranslations: ru('Дикое владение'), gold: 0, materials: 0, recruitmentSlots: 0, reserveLimit: 4, visionRadius: 2, defenseBonus: 0.1, battleType: 'settlement', allowsCaptainHire: false, isCapital: false, allowedForDomain: true, allowedForStronghold: false },
  ...
  { id: 'ruins', name: 'Ruins', nameTranslations: ru('Руины'), gold: 5, materials: 5, recruitmentSlots: 0, reserveLimit: 4, visionRadius: 2, defenseBonus: 0.1, battleType: 'settlement', allowsCaptainHire: false, isCapital: false, allowedForDomain: false, allowedForStronghold: true },
  { id: 'crossroads', name: 'Crossroads', nameTranslations: ru('Перекрёсток'), gold: 20, materials: 0, recruitmentSlots: 1, reserveLimit: 5, visionRadius: 2, defenseBonus: 0.1, battleType: 'settlement', allowsCaptainHire: false, isCapital: false, allowedForDomain: false, allowedForStronghold: true },
